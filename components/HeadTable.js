  ...
  return (
    <div className="py-3 px-2 border-b flex justify-between">
      <div className="flex items-center gap-2">
        <div className="mt-1">
          <input type="text" name="cari" id="cari" className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Cari..." />
        </div>
      </div>
      <div>
